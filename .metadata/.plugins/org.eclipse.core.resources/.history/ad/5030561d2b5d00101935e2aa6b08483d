...
public class BoardServletContextListener implements ServletContextListener, ServletContextAttributeListener {
    ...
    public void attributeAdded(ServletContextAttributeEvent event) {
    	System.out.println("---> ServletContext 객체에 " + event.getName() + "가 등록됨");
    }
    
    @Override
    public void attributeReplaced(ServletContextAttributeEvent event) {
    	System.out.println("---> ServletContext 객체에 " + event.getName() + "가 대체됨");
    }
    
    @Override
    public void attributeRemoved(ServletContextAttributeEvent event) {
    	System.out.println("---> ServletContext 객체에 " + event.getName() + "가 삭제됨");
    }
}